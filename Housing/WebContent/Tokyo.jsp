...
<input type="checkbox" name="area2" value="目黒区" />目黒区
<input type="checkbox" name="area2" value="大田区" />大田区
<input type="checkbox" name="area2" value="世田谷区" />世田谷区
</div>
<div>
<input type="checkbox" name="area2" value="渋谷区" />渋谷区
<input type="checkbox" name="area2" value="中野区" />中野区
...
<input type="checkbox" name="area2" value="足立区" />足立区
